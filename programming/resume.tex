...
Used javascript web workes to create interactive online version of the classic CS textbook Structure and Interpretation of Computer Programs. Project was voted to \#1 spot on Hacker News.
...
\section*{Skills}
\end{center}
Experienced in Python and Javascript. Some experience in C, C++, Racket Scheme, Haskell, TI-BASIC and Tcl. Intermediate Linux user - runs Ubuntu with a tiling window manager and can compile the occasional dependency. Longtime Dvorak (keyboard format) and LaTeX fan.
